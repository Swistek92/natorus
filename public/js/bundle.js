...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1Ijoic3dpc3RlayIsImEiOiJjbDVpZHJhcGwwNzQxM2JwZjF5Z3d4ZWNhIn0.DN-M96JOfTWIIa51qaqmsQ';
  ...
  locations.forEach(function (loc) {
    ...
    console.log(loc); // Add popup

    new mapboxgl.Popup({
      offset: 30
    }).setLngLat(loc.coordinates).setHTML("<p>Day ".concat(loc.day, "</p>")).addTo(map); // Extend map bounds to include current location
        ...
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _alerts.showAlert)('success', 'Logged i successfully');
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 4:
            ...
            if (res.data.status === 'success') {
              (0, _alerts.showAlert)('success', "".concat(type.toUpperCase(), " updated successfully!")); // showAlert('success', `updated successfully!`);
            }
...
var stripe = Stripe('pk_test_51LQHQFJY9lyn3XCq6r8n60xqY02RvScOFyCbNbt9tWCedmR7A9znTy0K3B2WVzI0RN0PX3vrWCnr9XUVqJ1Aq0bW00bD2kZTic');
  ...
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(tourId) {
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            stripe = Stripe('pk_test_51LQHQFJY9lyn3XCq6r8n60xqY02RvScOFyCbNbt9tWCedmR7A9znTy0K3B2WVzI0RN0PX3vrWCnr9XUVqJ1Aq0bW00bD2kZTic');
            _context.prev = 1;
            _context.next = 4;
